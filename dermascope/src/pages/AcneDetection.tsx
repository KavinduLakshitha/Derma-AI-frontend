    ...
    <div className="bg-[#5C2E0D] text-white min-h-screen">
      ...
      <main className="bg-[#F6E5D3] rounded-tl-3xl rounded-tr-3xl p-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="bg-[#5C2E0D] text-center text-white w-48 py-2 rounded-md">Acne detected</div>
          <div className="bg-[#5C2E0D] text-center text-white w-48 py-2 rounded-md">Acne severity</div>
        </div>
      </main>
    </div>
  );
